...
const (
	...
	// 订单未评价
	ErrorReason_ORDER_NOT_REVIEWED ErrorReason = 101
	// 评价已回复
	ErrorReason_REVIEW_REPLIED ErrorReason = 102
	// 未发表评价
...
const file_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	"\x1creview/v1/review_error.proto\x12\rapi.review.v1\x1a\x13errors/errors.proto*\xd4\x01\n" +
	"\vErrorReason\x12\x14\n" +
	"\n" +
	"NEED_LOGIN\x10\x00\x1a\x04\xa8E\x91\x03\x12\x13\n" +
	"\tDB_FAILED\x10\x01\x1a\x04\xa8E\xf4\x03\x12\x18\n" +
	"\x0eORDER_REVIEWED\x10d\x1a\x04\xa8E\x90\x03\x12\x1c\n" +
