...
const file_api_review_v1_review_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/review/v1/review.proto\x12\rapi.review.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\x89\x03\n" +
	...
	"\x04data\x18\x01 \x01(\v2\x19.api.review.v1.ReviewInfoR\x04data\"\xbc\x02\n" +
	"\n" +
	"ReviewInfo\x12\x1a\n" +
	"\breviewID\x18\x01 \x01(\x03R\breviewID\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\x03R\x06userID\x12\x18\n" +
	"\astoreID\x18\x03 \x01(\x03R\astoreID\x12\x18\n" +
	"\aorderID\x18\x04 \x01(\x03R\aorderID\x12\x14\n" +
	...
	"\tvideoInfo\x18\n" +
	" \x01(\tR\tvideoInfo\x12\x16\n" +
	"\x06status\x18\v \x01(\x05R\x06status\"\xd1\x01\n" +
